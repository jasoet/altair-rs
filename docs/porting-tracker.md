...
- **`altair-compress` 0.1.2** (date TBD on publish) — Path-based recipes for gzip, tar, zip, and tar.gz with zip-slip protection. Re-exports `flate2`, `tar`, `zip` for power users.
